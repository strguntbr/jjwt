...
class Jsr310DateSetterAndGetterTest {
    ...
    void testGetClaimExpiration_Instant_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getExpiration(Instant.class))
    }
    ...
    void testGetClaimIssuedAt_Instant_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getIssuedAt(Instant.class))
    }
    ...
    void testGetClaimNotBefore_Instant_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getNotBefore(Instant.class))
    }
    ...
    void testPutWithIat_Instant() {
        ...
        org.junit.Assert.assertEquals seconds, claims.get('iat') //conversion should have happened
    }
    ...
    void testPutWithNbf_Instant() {
        ...
        org.junit.Assert.assertEquals seconds, claims.get('nbf') //conversion should have happened
    }
    ...
    void testPutWithExp_Instant() {
        ...
        org.junit.Assert.assertEquals seconds, claims.get('exp') //conversion should have happened
    }
    ...
    void testPutWithNonSpecDate_Instant() {
        ...
        Instant now = Instant.ofEpochSecond(seconds)
        claims.put('foo', now)
        org.junit.Assert.assertEquals now, claims.get('foo') //conversion should NOT have occurred
    }
    /*************/
    ...
    void testGetClaimExpiration_OffsetDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getExpiration(OffsetDateTime.class))
    }
    ...
    void testGetClaimIssuedAt_OffsetDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getIssuedAt(OffsetDateTime.class))
    }
    ...
    void testGetClaimNotBefore_OffsetDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getNotBefore(OffsetDateTime.class))
    }
...
/*******/
    ...
    void testGetClaimExpiration_ZonedDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getExpiration(ZonedDateTime.class))
    }
    ...
    void testGetClaimIssuedAt_ZonedDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getIssuedAt(ZonedDateTime.class))
    }
    ...
    void testGetClaimNotBefore_ZonedDateTime_Success() {
        ...
        org.junit.Assert.assertEquals(expected, claims.getNotBefore(ZonedDateTime.class))
    }
